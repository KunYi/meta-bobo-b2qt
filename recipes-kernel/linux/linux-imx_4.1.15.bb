...
LINUX_VERSION_EXTENSION ?= "-bobo"

# Override SRCREV to point to a different commit in a bbappend file to
# build a different release of the Linux kernel.
SRCREV = "115e86de223fac3db6494b3613ec3d98e7fbcba7"
...
do_copy_defconfig () {
	if [ ${DO_CONFIG_V7_COPY} = "yes" ]; then
		# copy latest bobo_defconfig
		mkdir -p ${B}
		cp ${S}/arch/arm/configs/bobo_defconfig ${B}/.config
		cp ${S}/arch/arm/configs/bobo_defconfig ${B}/../defconfig
	fi
}
